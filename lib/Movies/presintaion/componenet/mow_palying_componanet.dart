...
import 'package:movies_app/Movies/presintaion/screens/movie_detail_screen.dart';
                        ...
                        children: [
                          ShaderMask(
                            ...
                            child: CachedNetworkImage(
                              height: 560.0,
                              imageUrl: AppConstances.imageURL(image:item.backdopPath ),
                              fit: BoxFit.cover,
                            ),
                          ),
                          Align(
...
// عشان ما يعمل rebuild كل ما تتغير state وحتى لو كانت ال state مش الي بستخدم اشي اسمه
// داخل ال BlobBuilder في اشي اسمه  buildWhen
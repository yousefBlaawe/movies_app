...
class MoviesDetailModel extends MoviesDetail
{
  const MoviesDetailModel({
    required super.id,
    required super.backdropPath,
    required super.voteAVG, 
    required super.releasDate,
    required super.title,
    required super.overview,
    required super.geners,
    required super.runTime});
  
  factory MoviesDetailModel.fromJason(Map<String,dynamic>jason)
  {
    return MoviesDetailModel(
        id: jason['id'],
        backdropPath: jason['backdrop_path'],
        voteAVG: jason['vote_average'],
        releasDate: jason['release_date'],
        title: jason['title'],
        overview: jason['overview'],
        geners:List<GenresModel>.from((jason['genres'].map((e)=>GenresModel.fromJason(e)))),
